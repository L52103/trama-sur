...
@Component({selector:'app-cart-page',imports:[RouterLink,IconComponent],template:`
  ...
  @else{<div class="empty"><h2>Tu carrito está esperando.</h2><p>Descubre prendas de calidad hechas para acompañarte.</p><a class="button" routerLink="/coleccion">Explorar colección</a></div>}
